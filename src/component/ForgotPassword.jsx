...
//   const [alertMessage, setAlertMessage] = useState("");
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://admin.bossdentindia.com/wp-json/custom/v1/forgot-password",
        {
          phone_number: phone,
        }
      );
      ...
      if (response.data.success) {
        ...
        // setShowAlert(true);
        toast.success(
          "Password reset phone sent successfully! Please check your inbox.",
          {
      ...
      alert(
        error.response?.data?.message || "Error sending reset password Whatsapp"
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleVerifyOtp = async () => {
    try {
      setLoading(true);
      const response = await axios.post(
        "https://admin.bossdentindia.com/wp-json/custom/v1/verify-reset-otp",
        {
          phone_number: phone,
          otp,
        }
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://admin.bossdentindia.com/wp-json/custom/v1/reset-password",
        {
          phone_number: phone,
    ...
    <div className="forgot-password-container" data-aos="fade">
      ...
      {step === 1 && (
        <div className="step-1">
          ...
          <div>
            <label>
              Please enter your registered mobile number to receive an OTP for
